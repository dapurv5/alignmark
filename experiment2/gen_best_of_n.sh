...
N=${1:-2}
EXP_NAME=${2:-"exp_002_truthfulqa_beam_rewards_armo_truthfulness"}
TGT_DIR_NAME=${3:-"exp_002_truthfulqa_beam_rewards_armo_truthfulness_BoN"}
...
python generate_best_of_n.py \
    ...
    --src_fields "watermarked_texts,watermarked_texts_truthfulness_score,watermarked_texts.is_watermarked,watermarked_texts.score,watermarked_texts.pvalue" \
    --tgt_score_field "watermarked_text_reward_score" \
    --tgt_fields "watermarked_text,watermarked_text_truthfulness_score,watermarked_text.is_watermarked,watermarked_text.score,watermarked_text.pvalue" \
    --n $N \
    --filename_pattern "*_truthfulness.jsonl"
